...
- **Math over Libraries**: If physics issues arise, implement a mathematical solution rather than importing heavy libraries.
...
Every new game must be created in a dedicated subdirectory under `/games` (e.g., `/games/03-game-name`) and **MUST** follow this exact structure:
